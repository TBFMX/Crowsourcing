...
class GalleriesControllerTest < ActionController::TestCase
  ...
  test "should create gallery" do
    assert_difference('Gallery.count') do
      post :create, gallery: { description: @gallery.description, project_id: @gallery.project_id, title: @gallery.title }
    end
  ...
  test "should update gallery" do
    patch :update, id: @gallery, gallery: { description: @gallery.description, project_id: @gallery.project_id, title: @gallery.title }
    assert_redirected_to gallery_path(assigns(:gallery))
  end
